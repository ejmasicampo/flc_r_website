...
None of the other classroom perceptions (self-efficacy, perceived involvement, big picture appreciation, and good rapport) varied significantly across time, all |βs| < .079, all |*t*s| < 1.47, *p*s > .144. Autonomous motivation, however, did also change significantly over time, β = -.6236, *t*(153.51) = -4.930, *p* < .001, such that it became lower across time points.  See Figure 2. 
Figure 2. 
<center>
```{r echo=FALSE}
...
*Note*. The above violin plot shows the distributions of students' autonomous motivation scores across the first four time points.  

I next analzyed the whether classroom perceptions were associated with autonomous motivation. For this analysis, I conducted a mixed effects model predicting autonomous motivation with student and time point as random factors and the five perceptions (self-effiacy, perceived involvement, big picture appreciation, and good rapport) as fixed factors. The results revealed that good rapport was significantly linked to autonomous motivation, β = .387, t(191.34) = 1.98, p = .049. 
